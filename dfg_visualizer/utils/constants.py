...
GRAPH_VIZ_NODE_DATA = (
    '<table cellpadding="3" cellborder="1" cellspacing="0" border="0">\n{}</table>\n'
)
...
GRAPH_VIZ_START_END_LINK = '{}->{}[penwidth="{}" fontsize="16" style="dashed" arrowhead="none" label=<\n<table cellpadding="0" cellborder="0" cellspacing="0" border="0">\n\t<tr><td bgcolor="white"><font face="arial" color="black">{}</font></td></tr>\n</table>>]\n'
