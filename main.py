...
import multi_persperctive_dfg_viewer
...
event_log = multi_persperctive_dfg_viewer.format_log(event_log)

(
    multi_persperctive_dfg,
    start_activities,
    end_activities,
) = multi_persperctive_dfg_viewer.discover_multi_perspective_dfg(event_log)
